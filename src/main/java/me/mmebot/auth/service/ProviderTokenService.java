...
public class ProviderTokenService {
    ...
    public void refreshAccessToken() {
        ProviderTokenEntity providerToken = providerTokenRepository.findByProvider(PROVIDER_GOOGLE)
    ...
    private void storeProviderTokens(GoogleTokenResponse tokenResponse) {
        String clientId = resolveClientId();
        ProviderTokenEntity providerToken = providerTokenRepository.findByProviderAndClientId(PROVIDER_GOOGLE, clientId)
                .orElseGet(() -> ProviderTokenEntity.builder()
    ...
    public void storeGoogleAuthorizationCode(String authorizationCode) {
        ...
        String clientId = resolveClientId();
        try {
            ProviderTokenEntity token = providerTokenRepository.findByProviderAndClientId(PROVIDER_GOOGLE, clientId)
                    .orElseGet(() -> ProviderTokenEntity.builder()
                            .provider(PROVIDER_GOOGLE)
                            .clientId(clientId)
                            .build());
    ...
    public String getRefreshToken(String provider) {
        ProviderTokenEntity providerToken = providerTokenRepository.findByProviderAndClientId(provider, resolveClientId())
