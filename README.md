...
## 개발 동기
- 요즘 사람들은 AI를 단순한 도구가 아닌 친구처럼 여기며 고민을 털어놓고 있습니다. 그만큼 사회는 정서적으로 결핍되어 있고 혼자 고민을 앓는 사람들이 많다고 느꼈습니다.
- 저 역시 AI에게 속마음을 토로하던 중 이런 질문이 들었습니다. “만약 AI가 내가 썼던 말들을 기억하고, 새로운 대화에서도 과거의 이야기를 기억하며 공감해주면 어떨까?”
- 그래서 **일기를 기반으로 사용자의 상황과 감정을 기억하고 진심 어린 대화를 이어가는 AI, mme-bot** 을 개발하고 있습니다.

## 버전 히스토리
- **v1.0.0** : MVP 버전. 고민을 작성하고 그에 따라 고민 상담 채팅을 할 수 있는 기능 제공.
- **v1.1.0** : 봇의 말투 수정 및 GPT 모델 변경을 통한 채팅 퀄리티 향상.
